...
public class ShopCar_delete_single {
    static final int PORT = 6204;
    ServerSocket delete_server;

    public ShopCar_delete_single() throws IOException {
    ...
    public void delete_serve() throws IOException {
        ...
        while (true){
            try {
                ...
                json1.put("flag",ShopCar.delete(user,id));
    ...
    public static void main() throws IOException {
        new ShopCar_delete_single().delete_serve();
    }
}

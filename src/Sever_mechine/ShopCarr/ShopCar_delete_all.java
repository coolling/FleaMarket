...
public class ShopCar_delete_all {
    static final int PORT = 6203;
    ServerSocket delete_server;

    public ShopCar_delete_all() throws IOException {
    ...
    public void delete_serve() throws IOException {
        ...
        while (true){
            try {
                ...
                json1.put("flag",ShopCar.deleteAll(user));
    ...
    public static void main() throws IOException {
        new ShopCar_delete_all().delete_serve();
    }
}

...
import Sever_mechine.PASS.Good_Ts;
...
public class Goods_buy {
    static final int PORT = 6119;
    ServerSocket buy_server;

    public Goods_buy() throws IOException {
    ...
    public void buy_serve() throws IOException {
        ...
        while (true){
            try {
                ...
                int good = json.getIntValue("goodsId");
                int amount = json.getIntValue("amount");
                JSONObject json1 = new JSONObject();
                json.put("flag", Good_Ts.mission(user,good,amount));

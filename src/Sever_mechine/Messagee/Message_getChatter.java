...
import Sever_mechine.Good.Goods;
import com.alibaba.fastjson.JSONObject;
import java.io.*;
import java.net.ServerSocket;
import java.net.Socket;

public class Message_getChatter {
    static final int PORT = 9997;
    ServerSocket get_server;

    public Message_getChatter() throws IOException {
    ...
    public void get_serve() throws IOException {
        ...
        while (true) {
            try {
                ...
                System.out.println("A new one want chatter：" + socket.getLocalAddress() + "：" + socket.getLocalPort()); //客户端信息
                ...
                json1 = Message.getChatter(json.getString("user"));

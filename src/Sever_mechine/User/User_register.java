...
public class User_register {
    ...
    public User_register() throws IOException {
    ...
    public void check_serve() throws IOException {
        ...
        while (true){
            try {
                ...
                System.out.println("A new one want to register：" + socket.getLocalAddress() + "：" + socket.getLocalPort()); //客户端信息
                ...
                int flag = Users.register(id,pass);

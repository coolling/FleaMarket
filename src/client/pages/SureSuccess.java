...
public class SureSuccess extends JFrame {
    String id;
    String title;
    public SureSuccess (String id,String title) {
        super();
        this.title=title;
        this.id=id;
        setLayout(null);
    ...
    private void view() {
        ...
        CheckRecordEvent checkMyGoodsEvent =new CheckRecordEvent(back,this,id);
        back.addMouseListener(checkMyGoodsEvent);
        ...
        JLabel goIndex = new JLabel("交易记录");

...
public class RegisterSuccess extends JFrame {
    ...
    private void view() {
        ...
        head.add(welcome);
        JLabel registerSuccess = new JLabel("注册成功！");
        ...
        RegisterEvent backLogin = new RegisterEvent(press,this);
        back.addMouseListener(backLogin);
        ...
        JLabel goIndex = new JLabel("登陆界面");

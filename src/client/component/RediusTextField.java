...
public class RediusTextField extends JTextField implements FocusListener {
    int redius = 0;
    int type =1;
    String text = "";
    public RediusTextField(int x, int redius) {
        super(x);
        this.redius = redius;
    ...
    public RediusTextField(int x, int redius, String text) {
        super(x);
        this.redius = redius;
        this.text=text;
        setFont(new Font("华文宋书", Font.PLAIN, 22));
    ...
    public RediusTextField(int x, int redius, int type, String text) {
        super(x);
        this.redius = redius;
       this.type =type;
       this.text=text;
